		...
		<main id="main" class="site-main main">
			<section class="hero">
    			...
    			<div class="container">
      				...
      				<h1 class="display-1 text-bold">가입에 성공하셨습니다!</h1>
      				<div>
      				<a class="button button-brand btn-lg mb-5 mb-lg-2" href="./main">메인으로</a>
      				<a class="button button-brand btn-lg mb-5 mb-lg-2" href="./signin">로 그 인</a>
      				</div>
    			</div>
			</section>
		</main>
